    ...
    <body>
        <div class="container">
            ...
            <% String message=(String) request.getAttribute("message"); String vnpAmount=(String)
                request.getAttribute("vnp_Amount"); String vnpOrderInfo=(String) request.getAttribute("vnp_OrderInfo");
                String vnpTxnRef=(String) request.getAttribute("vnp_TxnRef"); String vnpTransactionNo=(String)
                request.getAttribute("vnp_TransactionNo"); String vnpResponseCode=(String)
                request.getAttribute("vnp_ResponseCode"); %>
                ...
                <div class="transaction-info">
                    ...
                    <p><strong>Số tiền:</strong>
                        <%= vnpAmount !=null ? vnpAmount : "Không có" %> VND
                    </p>
