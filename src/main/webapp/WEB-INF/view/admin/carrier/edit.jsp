<%@page contentType="text/html" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <head>
            ...
            <title>Dashboard - Chỉnh Sửa Nhà Vận Chuyển</title>
                ...
                <div id="layoutSidenav_content">
                    <main>
                        <div class="container mt-5">
                            <h1 class="text-center mb-4">Chỉnh Sửa Nhà Vận Chuyển</h1>
                            <div class="card shadow-sm p-4">
                                <form action="${pageContext.request.contextPath}/admin/carrier/edit/${carrier.id}"
                                    method="post">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name"
                                            value="${carrier.name}" placeholder="Nhập tên nhà vận chuyển" required />
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="number" class="form-control" id="shippingFee" name="shippingFee"
                                            value="${carrier.shippingFee}" placeholder="Nhập phí vận chuyển" required
                                            step="0.01" />
                                    </div>
