                    ...
                    <main>
                        <div class="container-fluid px-4">
                            ...
                            <ol class="breadcrumb mb-4">
                                ...
                                <li class="breadcrumb-item"><a href="/admin/product" class="text-decoration-none">Sản
                                        phẩm</a></li>
                            ...
                            <div class="card shadow-sm mt-5">
                                <div
                                    ...
                                    <a href="/admin/promotion/add" class="btn btn-light btn-sm">+ Thêm Khuyến mãi
                                        mới</a>
                                </div>
                                <div class="card-body">
                                        ...
                                        <tbody>
                                            <c:forEach var="promotion" items="${promotions}">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="/admin/promotion/edit/${promotion.id}"
                                                            class="btn btn-warning btn-sm me-1">
                                                            <i class="fas fa-edit"></i> Sửa
                                                        </a>
                                                        <a href="/admin/promotion/delete/${promotion.id}"
