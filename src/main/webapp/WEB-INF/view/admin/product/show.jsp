<%@ page contentType="text/html" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
            ...
            <body class="sb-nav-fixed" style="margin-top: 140px;">
                                    ...
                                    <form action="/admin/product" method="get"
                                        ...
                                        <div>
                                            ...
                                            <input type="text" id="shopName" name="shopName" class="form-control"
                                                value="${param.shopName}" placeholder="Enter shop name">
                                        </div>
                                        <div>
                                                ...
                                                <c:forEach var="product" items="${products}">
                                                    ...
                                                    <c:if
                                                        ...
                                                        <c:if
                                                            ...
                                                            <!-- Lọc theo nhà máy -->
                                                            <c:if
                                                                test="${empty param.shopName || product.shop.name.toLowerCase().contains(param.shopName.toLowerCase())}">
                                                                <tr>
                                                                    <td>${product.id}</td>
                                                                    <td>${product.name}</td>
                                                                    <td>
