                                    ...
                                    <div class="mt-5">
                                        <div class="row">
                                            <div class="col-12 mx-auto">
                                                ...
                                                <form action="/admin/product/search" method="GET" class="mt-4">
                                                    <div class="d-flex align-items-center">
                                                        <label for="shopId" class="me-2 fw-bold">Tìm kiếm:</label>
                                                        <select name="shopId" id="shopId" class="form-select me-2"
                                                            style="width: 200px;">
